...
class MultiVendorStockRule(models.Model):
	_inherit = 'stock.rule'
	...
	def _run_buy(self, procurements):
		...
		for procurement, rule in procurements:
			...
			if not suppliers:
				suppliers = procurement.product_id._prepare_sellers(False).filtered(
			...
			for supplier in suppliers:
				...
				procurements_by_po_domain[domain].append((procurement, rule, supplier))
		...
		for domain, procurements_rules in procurements_by_po_domain.items():
			...
			procurements, rules, supplier = zip(*procurements_rules)
			procurement.values['supplier'] = supplier[0]
